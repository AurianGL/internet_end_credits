export const exlibris: string[] = [
  ...
  `
      The diagrams carrefully crafted into my pictures were no longer making as
    `,
  `much sense if they were show to a random audience.`,
