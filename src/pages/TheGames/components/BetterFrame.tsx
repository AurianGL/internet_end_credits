      ...
      <div className="flex justify-around gap-4 w-full">
        <div className="flex justify-center mt-4">
          <div className="grid grid-cols-3 grid-rows-3 gap-0">
            <div></div>
            <button
              className="rounded-t-lg col-start-2 row-start-1 w-12 h-12  bg-transparent bg-gray-400 text-red-500 font-death text-lg"
            ...
            <button
              className="rounded-l-lg col-start-1 row-start-2 w-12 h-12  bg-transparent  bg-gray-400 text-blue-500 font-death text-lg"
            ...
            <button className="rounded-r-lg w-12 h-12  bg-transparent bg-gray-400 text-blue-500 font-death text-lg">
              Right
            </button>
            <button
              className="rounded-b-lg col-start-2 row-start-3 w-12 h-12  bg-transparent  bg-gray-400 text-red-500 font-death text-lg"
          ...
          <div className="ml-10 grid grid-cols-2 grid-rows-2 gap-0">
            <button
              className="w-12 h-12 rounded-full bg-red-500 font-death text-lg"
            ...
            <div />
            <button
              className="w-12 h-12 rounded-full bg-blue-500 font-death text-lg"
